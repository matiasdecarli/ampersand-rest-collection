...
module.exports = function (method, model, options) {
    ...
    if (localStorage.getItem(params.url) && type!=='POST')
        options.success(JSON.parse(localStorage.getItem(params.url)), 'success');
    ...
    var request = options.xhr = xhr(ajaxSettings, function (err, resp, body) {
        ...
        if (body && typeof body === 'string') {
            try {
                if (method==='read') localStorage.setItem(params.url, resp.body);
